...
OWNER_USERNAME = getenv("OWNER_USERNAME","iax")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "NBot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "Nexiko")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "MissYumikoo")
EVALOP = list(map(int, getenv("EVALOP", "6928819775").split()))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/StarShinning03/Thar",
)
...
AMOP = [Hᴇʏ, {0} \nI'ᴍ {1},\n\n<b>Tʜᴇ ᴍᴏsᴛ ᴩᴏᴡᴇʀғᴜʟ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ</b>\n──────────────────\n<b><u>ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ + sᴘᴇᴄɪᴀʟ ᴛᴀɢ</b></u>\n<b>๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʜᴇʟᴩ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴍʏ ᴍᴏᴅᴜʟᴇs ᴀɴᴅ ᴄᴏᴍᴍᴀɴᴅs.</b>",
        "Hᴇʏ, {0} \nI'ᴍ {1},\n\n<b>Tʜᴇ ᴍᴏsᴛ ᴩᴏᴡᴇʀғᴜʟ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ</b>\n──────────────────\n<b><u>ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ + sᴘᴇᴄɪᴀʟ ᴛᴀɢ</b></u>\n<b>๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʜᴇʟᴩ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴍʏ ᴍᴏᴅᴜʟᴇs ᴀɴᴅ ᴄᴏᴍᴍᴀɴᴅs.</b>",
        "Hᴇʏ, {0} \nI'ᴍ {1},\n\n<b>Tʜᴇ ᴍᴏsᴛ ᴩᴏᴡᴇʀғᴜʟ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ</b>\n──────────────────\n<b><u>ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ + sᴘᴇᴄɪᴀʟ ᴛᴀɢ</b></u>\n<b>๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʜᴇʟᴩ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴍʏ ᴍᴏᴅᴜʟᴇs ᴀɴᴅ ᴄᴏᴍᴍᴀɴᴅs.</b>",
        "Hᴇʏ, {0} \nI'ᴍ {1},\n\n<b>Tʜᴇ ᴍᴏsᴛ ᴩᴏᴡᴇʀғᴜʟ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ</b>\n──────────────────\n<b><u>ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ + sᴘᴇᴄɪᴀʟ ᴛᴀɢ</b></u>\n<b>๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʜᴇʟᴩ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴍʏ ᴍᴏᴅᴜʟᴇs ᴀɴᴅ ᴄᴏᴍᴍᴀɴᴅs.</b>",
        "Hᴇʏ, {0} \nI'ᴍ {1},\n\n<b>Tʜᴇ ᴍᴏsᴛ ᴩᴏᴡᴇʀғᴜʟ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ</b>\n──────────────────\n<b><u>ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜsɪᴄ + sᴘᴇᴄɪᴀʟ ᴛᴀɢ</b></u>\n<b>๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʜᴇʟᴩ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴍʏ ᴍᴏᴅᴜʟᴇs ᴀɴᴅ ᴄᴏᴍᴍᴀɴᴅs.</b>"
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/c280a102ad1d7379bc166.jpg"
)
PING_IMG_URL = getenv(
